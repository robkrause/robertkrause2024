...
3. Once the installation is done and the remaining Windows Update are finished, you can disable most unwanted applications, even Copilot, Edge and Store. A few apps are tagged as system apps and can be forcefully uninstalled but might break things and often return with an update
...
- Office: I already described [here](https://robertkrau.se/blog/clean-windows-10-install/) how to install only the Microsoft Office apps that you really want. Somehow, I see apps like Access returning “magically” recently – disgusting
